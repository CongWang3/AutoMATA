...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", default="./result/model.pth", type=str, help="Path to the trained model file")
    parser.add_argument("--model_autoencoder_path", default="./result/model_autoencoder.pth", type=str, help="Required only when the 'model_type' is AutoEncoder, ; specify the path to the saved 'model_autoencoder.pth' file.")
    ...
    if (model_type == 'AutoEncoder'):
        savename = "./result/model_autoencoder.pth"
        ...
        savename_cls = "./result/model_cls.pth"
