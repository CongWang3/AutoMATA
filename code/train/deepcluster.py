...
def prepare_data(seed, batch_size, ratio="8:1:1", kfold=0):
    ...
    if ratio == "0" and kfold == 0:
        ...
        data = pd.read_csv(PATH_VAL, sep="\t")  # the path of validation dataset
        data = data.dropna().values.astype(float) 
...
def main():
    ...
    parser.add_argument('--loss_function', type=str, default='deepcluster', 
                       ...
                       help='Loss function type:\n'
                            ...
                            'combined: Combined clustering loss\n'
                            'center: Center loss\n'
    ...
    parser.add_argument('--beta', type=float, default=1.0, help='Clustering loss weight')
    parser.add_argument('--update_cluster_freq', type=int, default=10, help='Update cluster centers frequency')
